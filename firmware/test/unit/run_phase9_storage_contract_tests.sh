...
BUILD_DIR="${TMPDIR:-/tmp}/reeflow_phase9_storage_contract_tests"
mkdir -p "$BUILD_DIR"
...
g++ -std=c++17 -Wall -Wextra -Werror \
  ...
  -I"$FIRMWARE_DIR/src" \
  -I"$FIRMWARE_DIR/test" \
  "$FIRMWARE_DIR/test/unit/test_storage_contracts.cpp" \
  ...
  -o "$BUILD_DIR/test_storage_contracts"

"$BUILD_DIR/test_storage_contracts"
