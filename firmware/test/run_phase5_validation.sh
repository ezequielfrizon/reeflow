...
"$TEST_DIR/unit/run_phase5_unit_tests.sh"
"$TEST_DIR/integration/run_phase5_integration_tests.sh"
...
"$TEST_DIR/unit/run_phase2_watchdog_tests.sh"
...
"$TEST_DIR/unit/run_phase4_water_level_sensor_boundary_tests.sh"
"$TEST_DIR/unit/run_phase4_vl6180x_level_sensor_tests.sh"
"$TEST_DIR/unit/run_phase4_water_level_state_evaluator_tests.sh"
"$TEST_DIR/unit/run_phase4_water_level_service_tests.sh"
"$TEST_DIR/integration/run_phase4_water_level_scheduler_integration_tests.sh"

"$TEST_DIR/integration/run_phase5_scope_review.sh"
