...
BUILD_DIR="${TMPDIR:-/tmp}/reeflow_phase2_core_app_integration_tests"
mkdir -p "$BUILD_DIR"
...
g++ -std=c++17 -Wall -Wextra -Werror \
  ...
  -I"$FIRMWARE_DIR/src" \
  -I"$FIRMWARE_DIR/test" \
  "$FIRMWARE_DIR/test/integration/test_core_app_integration.cpp" \
  ...
  -o "$BUILD_DIR/test_core_app_integration"

"$BUILD_DIR/test_core_app_integration"
