...
BUILD_DIR="${TMPDIR:-/tmp}/reeflow_phase9_storage_boot_restore_integration_tests"
mkdir -p "$BUILD_DIR"
...
g++ -std=c++17 -Wall -Wextra -Werror \
  ...
  -o "$BUILD_DIR/test_storage_boot_restore_integration"

"$BUILD_DIR/test_storage_boot_restore_integration"
