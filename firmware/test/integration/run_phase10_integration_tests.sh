...
BUILD_DIR="${TMPDIR:-/tmp}/reeflow_phase10_network_integration_tests"
mkdir -p "$BUILD_DIR"
...
g++ -std=c++17 -Wall -Wextra -Werror \
  ...
  -o "$BUILD_DIR/test_network_boot_scheduler_integration"

"$BUILD_DIR/test_network_boot_scheduler_integration"
